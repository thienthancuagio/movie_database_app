...
import 'package:movie_database_app/module/popular/popular_block.dart';
...
class PopularList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<PopularBloc, BaseState>(
      builder: (BuildContext content, BaseState state) {
        ...
        if (state is LoadingState) {
          ...
          return SmartRefresher(
              ...
              onRefresh: () {
                listData = [];
                BlocProvider.of<PopularBloc>(content).add(RefreshPopular());
              },
              onLoading: () {
                BlocProvider.of<PopularBloc>(content).add(LoadMorePopular());
              },
